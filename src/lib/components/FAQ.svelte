    ...
    <section class="py-8 lg:py-20" id="faq">
        <div class="container">
            <div class="text-center">
                <h2 class="text-3xl font-semibold sm:text-4xl">FAQs</h2>
                <p class="text-base-content/80 mt-2 sm:text-lg">
            ...
            <div class="mt-12 flex justify-center gap-6">
                <div class="space-y-4 lg:w-1/2">
                    <div class="collapse-arrow border-base-content/10 collapse border">
                        ...
                        <div class="collapse-content">
                            <p class="text-base">
                                ...
                                updates, and accessibility. It allows businesses to focus on core operations while the
                                software provider handles maintenance and updates.
                            </p>
                        </div>
                    </div>
                    <div class="collapse-arrow border-base-content/10 collapse border">
                        ...
                        <div class="collapse-content">
                            <p class="text-base">
                                Our SaaS platform offers a range of features, including collaborative tools, real-time
                                analytics, integrations with popular applications, user-friendly interfaces, and
